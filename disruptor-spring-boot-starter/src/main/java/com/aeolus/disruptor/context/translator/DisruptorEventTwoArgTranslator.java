...
public class DisruptorEventTwoArgTranslator implements EventTranslatorTwoArg<DisruptorDataEvent, String, String> {

    @Override
    public void translateTo(DisruptorDataEvent dataEvent, long sequence, String event, String tag) {
