...
package com.aeolus.disruptor.context.config;

import com.aeolus.disruptor.exception.EventHandleException;
...
public class HandlerDefinitionMap implements Map<String, HandlerDefinitionMap.Section> {
    ...
    public String toString() {
        if (this.sections == null || this.sections.isEmpty()) {
            ...
            int i = 0;
            for (HandlerDefinitionMap.Section section : this.sections.values()) {
                if (i > 0) {
                    sb.append(",");
                }
