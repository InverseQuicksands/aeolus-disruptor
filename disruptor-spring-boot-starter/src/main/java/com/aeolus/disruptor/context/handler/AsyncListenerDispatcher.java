 ...
 * @version v1.0
 */
public class AsyncListenerDispatcher implements EventHandler<DisruptorDataEvent> {
     ...
     */
    @Override
    public void onEvent(DisruptorDataEvent dataEvent, long sequence, boolean endOfBatch) throws Exception {
