...
@Component("inDbPreHandler")
public class InDbPreHandler implements DisruptorHandler<DisruptorDataEvent> {

    private static final Logger logger = LoggerFactory.getLogger(InDbPreHandler.class);
